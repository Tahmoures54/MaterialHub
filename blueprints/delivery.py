...
def delivery_order():
    ...
    return render_template('delivery_order.html', mode='dashboard')
...
def get_deliveries():
    try:
        ...
        return render_template('delivery_order.html', mode='list', deliveries=deliveries)
...
def create_delivery():
    ...
    if form.validate_on_submit():
        try:
            ...
            return render_template('500.html'), 500
    return render_template('delivery_order.html', mode='create', form=form)