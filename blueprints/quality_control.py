...
def quality_control():
    ...
    return render_template('quality_control.html', mode='dashboard')
...
def get_quality_controls():
    try:
        ...
        return render_template('quality_control.html', mode='list', quality_controls=quality_controls)
...
def create_quality_control():
    ...
    if form.validate_on_submit():
        try:
            ...
            return render_template('500.html'), 500
    return render_template('quality_control.html', mode='create', form=form)